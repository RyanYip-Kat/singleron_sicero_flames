...
#$java -jar -Xmx64g ${jarpath}/NanoporeBC_UMI_finder-1.0.jar -i $outdir/GEUS.bam -o $outdir/GEUS10xAttributes.bam -k $outdir/illumina.bam.obj --ncpu 16 --maxUMIfalseMatchPercent 2 --maxBCfalseMatchPercent 5 --logFile $outdir/out.log
